            ...
            findings.append(
                {
                    ...
                    "severity": "HIGH",
                    "type": "SQL Injection",
                    "description": "사용자 입력이 SQL 문자열에 직접 삽입될 수 있습니다.",
            ...
            findings.append(
                {
                    ...
                    "description": "비밀값으로 보이는 문자열이 소스 코드에 하드코딩되어 있습니다.",
                    "suggestion": "Secrets Manager, Parameter Store 또는 Lambda 환경변수를 사용하세요.",
                }
            )
            ...
            findings.append(
                {
                    ...
                    "severity": "LOW",
                    "type": "Style",
                    "description": "쉼표 뒤 공백이 없어 일반적인 PEP8 스타일과 맞지 않습니다.",
            ...
            findings.append(
                {
                    ...
                    "severity": "LOW",
                    "type": "Logging",
                    "description": "애플리케이션 코드에서 print를 사용하면 로그 레벨 관리와 추적이 어렵습니다.",
            ...
            findings.append(
                {
                    ...
                    "type": "Complexity",
                    "description": f"{item['name']} 함수의 Cyclomatic Complexity는 {item['complexity']}입니다.",
...
def render_markdown_review(pr, review):
    ...
    lines.extend(
        [
            "",
            "### 테스트 코드 제안",
            "- SQL 실행 코드는 정상 입력과 악의적 입력을 모두 테스트하세요.",
            "- 중첩 조건문이 있는 함수는 분기별 단위 테스트를 추가하세요.",
